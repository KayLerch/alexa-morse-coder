...
import me.lerch.alexa.state.model.AlexaStateIgnore;
import me.lerch.alexa.state.model.AlexaStateModel;
import me.lerch.alexa.state.model.AlexaStateSave;
...
public class MorseUser extends AlexaStateModel {
    ...
    @AlexaStateSave(Scope = AlexaScope.USER)
    private boolean deviceIntegrationEnabled = false;
    @AlexaStateSave(Scope = AlexaScope.USER)
    private boolean farnsworthEnabled = false;
    @AlexaStateSave(Scope = AlexaScope.SESSION)
    private boolean isAskedForNewExercise = false;
    @AlexaStateSave(Scope = AlexaScope.SESSION)
    private boolean isAskedForAnotherEncode = false;
    @AlexaStateSave(Scope = AlexaScope.SESSION)
    private boolean isAskedForAnotherTry = false;
