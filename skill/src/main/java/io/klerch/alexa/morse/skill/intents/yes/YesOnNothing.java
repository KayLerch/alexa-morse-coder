...
@AlexaIntentListener(builtInIntents = AlexaIntentType.INTENT_YES, priority = -1)
public class YesOnNothing extends AbstractHandler implements AlexaIntentHandler {
    @Override
