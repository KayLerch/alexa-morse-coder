...
@AlexaIntentListener(customIntents = "CfgSpeedDown")
public class SpeedDecreasedOnExercise extends AbstractHandler implements AlexaIntentHandler {
    private static final Logger log = Logger.getLogger(SpeedDecreasedOnExercise.class);
