...
public class ResponsePhrases {
    ...
    private static final List<String> correctAnswerIs = Arrays.asList("The correct answer is", "The decoded word is", "The word you were looking for is", "The right answer would have been", "The correct answer would have been");
