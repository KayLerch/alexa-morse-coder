...
public class SpeedDecreased extends AbstractHandler implements AlexaIntentHandler {
    private static final Logger log = Logger.getLogger(SpeedDecreased.class);
